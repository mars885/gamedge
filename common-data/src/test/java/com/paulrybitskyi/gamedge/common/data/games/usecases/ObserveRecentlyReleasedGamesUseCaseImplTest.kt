...
import com.paulrybitskyi.gamedge.common.data.games.usecases.discovery.ObserveRecentlyReleasedGamesUseCaseImpl
...
internal class ObserveRecentlyReleasedGamesUseCaseImplTest {
    ...
    fun `Emits games successfully`() {
        runTest {
            every { gamesLocalDataStore.observeRecentlyReleasedGames(any()) } returns flowOf(DATA_GAMES)
