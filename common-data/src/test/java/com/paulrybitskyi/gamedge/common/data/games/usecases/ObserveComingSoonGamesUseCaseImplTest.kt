...
import com.paulrybitskyi.gamedge.common.data.games.usecases.discovery.ObserveComingSoonGamesUseCaseImpl
...
internal class ObserveComingSoonGamesUseCaseImplTest {
    ...
    fun `Emits games successfully`() {
        runTest {
            every { gamesLocalDataStore.observeComingSoonGames(any()) } returns flowOf(DATA_GAMES)
