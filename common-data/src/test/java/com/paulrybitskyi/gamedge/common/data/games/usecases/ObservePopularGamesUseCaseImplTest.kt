...
import com.paulrybitskyi.gamedge.common.data.games.usecases.discovery.ObservePopularGamesUseCaseImpl
...
internal class ObservePopularGamesUseCaseImplTest {
    ...
    fun `Emits games successfully`() {
        runTest {
            every { gamesLocalDataStore.observePopularGames(any()) } returns flowOf(DATA_GAMES)
