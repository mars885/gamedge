...
import com.paulrybitskyi.gamedge.common.data.games.DataAgeRating
import com.paulrybitskyi.gamedge.common.data.games.DataAgeRatingCategory
import com.paulrybitskyi.gamedge.common.data.games.DataAgeRatingType
...
import com.paulrybitskyi.gamedge.common.data.games.DataGenre
import com.paulrybitskyi.gamedge.common.data.games.DataImage
import com.paulrybitskyi.gamedge.common.data.games.DataInvolvedCompany
import com.paulrybitskyi.gamedge.common.data.games.DataKeyword
import com.paulrybitskyi.gamedge.common.data.games.DataMode
import com.paulrybitskyi.gamedge.common.data.games.DataPlatform
import com.paulrybitskyi.gamedge.common.data.games.DataPlayerPerspective
import com.paulrybitskyi.gamedge.common.data.games.DataReleaseDate
import com.paulrybitskyi.gamedge.common.data.games.DataReleaseDateCategory
import com.paulrybitskyi.gamedge.common.data.games.DataTheme
import com.paulrybitskyi.gamedge.common.data.games.DataVideo
import com.paulrybitskyi.gamedge.common.data.games.DataWebsite
import com.paulrybitskyi.gamedge.common.data.games.DataWebsiteCategory
...
internal class DbGameMapper @Inject constructor() {
    ...
    private fun DatabaseCompany.toDataCompany(): DataCompany {
        return DataCompany(
            id = id,
            name = name,
...
internal fun DbGameMapper.mapToDataGames(databaseGames: List<DatabaseGame>): List<DataGame> {
    return databaseGames.map(::mapToDataGame)
}

internal fun DbGameMapper.mapToDatabaseGames(dataGames: List<DataGame>): List<DatabaseGame> {
