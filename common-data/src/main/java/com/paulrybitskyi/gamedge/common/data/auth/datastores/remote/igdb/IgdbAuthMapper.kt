...
internal class IgdbAuthMapper @Inject constructor() {
    ...
    fun mapToApiOauthCredentials(dataOauthCredentials: DataOauthCredentials): ApiOauthCredentials {
        return ApiOauthCredentials(
            accessToken = dataOauthCredentials.accessToken,
            tokenType = dataOauthCredentials.tokenType,
            tokenTtl = dataOauthCredentials.tokenTtl
        )
    }
