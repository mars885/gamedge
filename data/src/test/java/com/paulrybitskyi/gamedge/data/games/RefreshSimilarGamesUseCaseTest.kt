...
import com.paulrybitskyi.gamedge.data.games.usecases.RefreshSimilarGamesUseCaseImpl
...
private val USE_CASE_PARAMS = RefreshSimilarGamesUseCase.Params(DOMAIN_GAME, Pagination())


internal class RefreshSimilarGamesUseCaseTest {
    ...
    fun `Emits remote games when refresh is possible`() = runBlockingTest {
        throttler.canRefreshSimilarGames = true
    ...
    fun `Does not emit remote games when refresh is not possible`() = runBlockingTest {
        throttler.canRefreshSimilarGames = false
