...
internal class GetGameUseCaseTest {
    ...
    @Test
    fun `Emits game successfully`() = runBlockingTest {
    ...
    @Test
    fun `Emits not found error if game ID does not reference existing game`() = runBlockingTest {
