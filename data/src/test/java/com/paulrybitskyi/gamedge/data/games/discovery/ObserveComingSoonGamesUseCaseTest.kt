...
internal class ObserveComingSoonGamesUseCaseTest {


    private lateinit var gameMapper: GameMapper
    private lateinit var useCase: ObserveComingSoonGamesUseCaseImpl


    @Before
    fun setup() {
        gameMapper = GameMapper()
        useCase = ObserveComingSoonGamesUseCaseImpl(
