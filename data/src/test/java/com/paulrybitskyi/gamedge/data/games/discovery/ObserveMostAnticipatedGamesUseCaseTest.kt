...
internal class ObserveMostAnticipatedGamesUseCaseTest {


    private lateinit var gameMapper: GameMapper
    private lateinit var useCase: ObserveMostAnticipatedGamesUseCaseImpl


    @Before
    fun setup() {
        gameMapper = GameMapper()
        useCase = ObserveMostAnticipatedGamesUseCaseImpl(
