...
import com.paulrybitskyi.gamedge.domain.games.usecases.refreshers.RefreshSimilarGamesUseCase.Params
    ...
    override suspend fun execute(params: Params): Flow<DomainResult<List<Game>>> {
        ...
        return flow {
            if(throttlerTools.throttler.canRefreshSimilarGames(throttlerKey)) {
                ...
                emit(gamesDataStores.remote.getSimilarGames(dataGame, dataPagination))
            }
        }
        .onEachSuccess {
