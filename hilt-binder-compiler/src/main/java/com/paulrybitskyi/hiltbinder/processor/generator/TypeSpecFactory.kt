...
internal class TypeSpecFactory(
    private val bindingMethodSpecFactory: BindingMethodSpecFactory
) {
    ...
    fun createTypeSpec(moduleSchema: ModuleSchema): TypeSpec {
        return TypeSpec.interfaceBuilder(moduleSchema.interfaceName)
            ...
            .addMethods(bindingMethodSpecFactory.create(moduleSchema.bindings))
            .build()
    }
