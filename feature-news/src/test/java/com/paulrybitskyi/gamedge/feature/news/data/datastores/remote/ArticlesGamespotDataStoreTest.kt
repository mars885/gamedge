...
package com.paulrybitskyi.gamedge.feature.news.data.datastores.remote
...
import com.paulrybitskyi.gamedge.feature.news.data.datastores.remote.gamespot.GamespotArticleMapper
import com.paulrybitskyi.gamedge.feature.news.data.datastores.remote.gamespot.ArticlePublicationDateMapper
import com.paulrybitskyi.gamedge.feature.news.data.datastores.remote.gamespot.ArticlesGamespotDataStore
import com.paulrybitskyi.gamedge.feature.news.data.datastores.remote.gamespot.mapToDataArticles
    ...
    fun `Returns articles successfully`() {
        runTest {
            ...
            assertThat(result.get())
                .isEqualTo(apiArticleMapper.mapToDataArticles(API_ARTICLES))
        }
    }
