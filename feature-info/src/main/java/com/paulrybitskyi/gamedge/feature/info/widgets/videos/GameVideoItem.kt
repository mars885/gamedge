...
internal class GameVideoItem(model: GameVideoModel) : AbstractItem<
    GameVideoModel,
    GameVideoItem.ViewHolder,
    NoDependencies
>(model) {
    ...
    override fun createViewHolder(
        ...
        return ViewHolder(
            GameVideoView(parent.context).apply {
                val width = getDimensionPixelSize(R.dimen.game_videos_item_width)
                val margin = getDimensionPixelSize(R.dimen.game_videos_item_margin)

                thumbnailHeight = getDimensionPixelSize(R.dimen.game_videos_item_thumbnail_height)
