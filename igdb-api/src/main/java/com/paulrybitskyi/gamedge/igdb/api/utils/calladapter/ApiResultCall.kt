...
import com.paulrybitskyi.gamedge.igdb.api.utils.extensions.enqueue
...
private const val ERROR_BODY_MESSAGE_NAME = "title"
...
internal class ApiResultCall<T>(
    ...
    private fun ResponseBody.extractErrorMessage(): String {
        ...
        val message = jsonObject.getString(ERROR_BODY_MESSAGE_NAME)
