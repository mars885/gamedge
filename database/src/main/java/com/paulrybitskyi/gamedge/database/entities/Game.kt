...
package com.paulrybitskyi.gamedge.database.entities
...
internal data class Game(
    ...
    @ColumnInfo(name = Schema.POPULARITY) val popularity: Double?,
    ...
    @ColumnInfo(name = Schema.TIME_TO_BEAT) val timeToBeat: String,
