...
package com.paulrybitskyi.gamedge.category
...
import com.paulrybitskyi.gamedge.category.mapping.GamesCategoryUiStateFactory
...
import com.paulrybitskyi.gamedge.commons.ui.widgets.category.GamesCategoryUiState
...
internal class GamesCategoryViewModel @Inject constructor(
    ...
    private val gamesCategory = checkNotNull(savedStateHandle.get<GamesCategory>(PARAM_GAMES_CATEGORY))
